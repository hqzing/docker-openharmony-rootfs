...
# For curl.
curl -fsSL -O https://github.com/hqzing/build-musl-curl/releases/download/8.8.0/curl-8.8.0-linux-musl-arm64.tar.gz
tar -zxf curl-8.8.0-linux-musl-arm64.tar.gz
cp curl-8.8.0-linux-musl-arm64/bin/curl ramdisk/bin/
rm -rf curl-8.8.0-linux-musl-arm64*
