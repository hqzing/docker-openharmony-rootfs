...
query_component() {
    curl -fsSL 'https://ci.openharmony.cn/api/daily_build/build/list/component' \
        ...
        --data-raw '{"projectName":"openharmony","branch":"OpenHarmony-6.0-Release","pageNum":1,"pageSize":10,"deviceLevel":"","component":"dayu200-arm64","type":1,"startTime":"2025070100000000","endTime":"20990101235959","sortType":"","sortField":"","hardwareBoard":"","buildStatus":"success","buildFailReason":"","withDomain":1}'
}
...
# For toybox and curl.
cp system/lib64/platformsdk/libcrypto_openssl.z.so ramdisk/lib64/platformsdk/

# For curl.
cp system/lib64/platformsdk/libssl_openssl.z.so ramdisk/lib64/platformsdk/
...
cp system/etc/ssl/certs/cacert.pem ramdisk/etc/ssl/certs/
